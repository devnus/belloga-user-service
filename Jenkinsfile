pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL = 'git@git.swmgit.org:swm-13-main/13_swm56/belloga-user-service.git'
        TARGET_BRANCH = 'master'

        CONTAINER_NAME = 'belloga-user-service'

        SWAGGER_ID = 'belloga-swagger'
        OPEN_API_SPEC_NAME = 'open-api-3-user-service.json'

        AWS_CREDENTIAL_NAME = 'belloga-aws'
        ECR_PATH = '023778162658.dkr.ecr.ap-northeast-2.amazonaws.com'
        IMAGE_NAME = '023778162658.dkr.ecr.ap-northeast-2.amazonaws.com/belloga-user-service'
        ...
        stage('create application-prod') {
            steps {
				...
				withAWSParameterStore(credentialsId: "${env.AWS_CREDENTIAL_NAME}",
              				path: "/belloga/user/application/profile",
              				naming: 'basename',
